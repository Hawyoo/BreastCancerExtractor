...
def test_preview_colors_are_mode_specific_and_roi_draft_is_yellow():
    script = _script()
    ...
    assert 'activeRoi: {fill: "rgba(255,196,68,.18)", stroke: "#f2bd3e"}' in script
    assert "const color = editing ? COLORS.activeRoi : COLORS.roi" in script
